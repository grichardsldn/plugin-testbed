...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Testbench Demo Installer\n"
      else:
        line="OutputBaseFilename=Testbench Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Testbench Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Testbench installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Testbench Demo installer\n"
     else:
       line="SetupWindowTitle=Testbench installer\n"
